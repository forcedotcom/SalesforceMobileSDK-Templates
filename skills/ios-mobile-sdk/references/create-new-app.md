...
Continue at [`add-mobile-sdk.md`](add-mobile-sdk.md). After completing it, re-run `xcodegen generate` (and `pod install` if CocoaPods) so the project picks up newly created files.
